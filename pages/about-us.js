...
function AboutUs() {
    ...
    useEffect(() => {
        async function getRes() {
            const res = await request(`about-us/view`)
    ...
    return (
        <div className={styles.main}>
            ...
            <Container>
            {/* <div className={styles.title} dangerouslySetInnerHTML={{__html: `${terms?.title}`}}></div> */}
            ...
            <div className={styles.image__text__grid__style}>
                ...
                <div className={styles.margin_top1}>
                    <Image src={`${hostname}/${terms?.firstImage}`} height={400} width={500} />
                </div>
                <div className={styles.margin_top1}>
                    <Image src={`${hostname}/${terms?.secondImage}`} height={400} width={500} />
                </div>
                <div className={styles.margin_top} >
                    <div className={styles.firsttext} dangerouslySetInnerHTML={{__html: `${terms?.secondText}`}}></div>
                ...
                <div className={styles.margin_top}  >
                    <div className={styles.firsttext} dangerouslySetInnerHTML={{__html: `${terms?.thirdText}`}}></div>
                ...
                <div className={styles.margin_top1}>
                    <Image src={`${hostname}/${terms?.fourthImage}`} height={400} width={500} />
                </div>
                <div className={styles.margin_top} >
                <div className={styles.firsttext} dangerouslySetInnerHTML={{__html: `${terms?.fourthText}`}}></div>
                ...
                <div>
                <div className={styles.firsttext} dangerouslySetInnerHTML={{__html: `${terms?.fifthText}`}}></div>
                ...
                <div>
                    <Image src={`${hostname}/${terms?.fifthImage}`} height={400} width={500} />
                </div>
            </div>
            </Container>
